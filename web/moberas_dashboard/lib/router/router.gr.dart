...
import '../features/pacient/ui/dynamic/dynamic_chart_view.dart';
...
import '../features/pacient/ui/survey_app/survey_app_view.dart';
...
class Routes {
  ...
  static const String dynamicChartView = '/dynamic-chart-view';
  static const String surveyAppView = '/survey-app-view';
...
class AppRouter extends RouterBase {
  ...
  final _routes = <RouteDef>[
    ...
    RouteDef(Routes.dynamicChartView, page: DynamicChartView),
    RouteDef(Routes.surveyAppView, page: SurveyAppView),
  ];
  @override
  ...
  final _pagesMap = <Type, AutoRouteFactory>{
    ...
    DynamicChartView: (data) {
      final args = data.getArgs<DynamicChartViewArguments>(
        orElse: () => DynamicChartViewArguments(),
      );
      return MaterialPageRoute<dynamic>(
        builder: (context) => DynamicChartView(profile: args.profile),
        settings: data,
      );
    },
    SurveyAppView: (data) {
      final args = data.getArgs<SurveyAppViewArguments>(
        orElse: () => SurveyAppViewArguments(),
      );
      return MaterialPageRoute<dynamic>(
        builder: (context) => SurveyAppView(profile: args.profile),
        settings: data,
      );
    },
  };
...
/// DynamicChartView arguments holder class
class DynamicChartViewArguments {
  final UserProfile profile;
  DynamicChartViewArguments({this.profile});
}

/// SurveyAppView arguments holder class
class SurveyAppViewArguments {
  final UserProfile profile;
  SurveyAppViewArguments({this.profile});
}
