        ...
        builder: (context, model, child) => BusyOverlay(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(begin: Alignment.topRight, end: Alignment.bottomRight, colors: <Color>[Theme.of(context).primaryColor, Colors.white]),
                ),
                child: Padding(
                          ...
                          LoginButton(
                            ...
                            loginMethod: () async {
                              if (!formKey.currentState.validate()) {
                                ...
                                return model.login(email: emailController.text, password: passwordController.text);
                              }
                            },
                          ),
                          verticalSpaceMedium,
